        ...
        <div className="px-6 py-8">
            <div className="max-w-6xl mx-auto">
                <div className="bg-white rounded-3xl p-8 mb-5">
                    <h1 className="text-3xl font-bold mb-10">Welcome back Your name!</h1>
                    ...
                    <div className="grid grid-cols-2 gap-x-20">
                        <div>
                            <h2 className="text-2xl font-bold mb-4">Followed Bounties</h2>

                            <div className="grid grid-cols-2 gap-4">
                                <div className="col-span-2">
                                    <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                                        <div className="font-bold text-xl leading-none">Biology Research</div>
                                        <div className="mt-2">2 of 5 completed</div>
                                    </div>
                                </div>
                                <div className="col-span-2">
                                    <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                                        <div className="font-bold text-xl leading-none">Biology Research</div>
                                        <div className="mt-2">1 of 3 completed</div>
                                    </div>
                                </div>
                                <div className="col-span-2">
                                    <div className="p-4 bg-purple-100 rounded-xl text-gray-800">
                                        <div className="font-bold text-xl leading-none">Biology Research</div>
                                        <div className="mt-2">2 of 8 completed</div>
                                    </div>
                                </div>
                        ...
                        <div>
                            <h2 className="text-2xl font-bold mb-4">Observations received</h2>
